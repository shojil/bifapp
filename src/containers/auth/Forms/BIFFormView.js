...
class BIFAuthForm extends Component {
  static componentName = 'BIF Login';
  ...
  constructor(props) {
    ...
    const formFields = {};
    if (props.formFields.indexOf('Username') > -1) formFields.Username = this.validUsername;
  ...
  render = () => {
    ...
    return (
      <ScrollView
        ...
        contentContainerStyle={[AppStyles.containertrans]}
      >
